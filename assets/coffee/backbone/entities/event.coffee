JabberApp.module 'Entities', (Entities, App, Backbone, Marionette, $, _) ->
  ...
  Entities.EventCollection = App.Entities.Collection.extend(model: Entities.Event)
  API = getEvents: ->
    new Entities.EventCollection([
      {
        _id: 1
        date: '20/09/2013'
        name: 'Birthday'
        description: 'Age is high price to pay for maturity.'
      }
      {
        _id: 2
        date: '22/09/2013'
